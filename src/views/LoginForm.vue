...
// Login function to be called on form submit (calls createSession function and redirects to MovieList view)
...
<template>
  <main
    class="flex min-h-full flex-col justify-center align-center mt-10 mx-auto max-w-2xl text-white gap-3"
  >
    <h2 class="text-xl font-bold self-center">Log In</h2>
    <form
      action=""
      @submit.prevent="login"
      class="flex flex-col justify-center align-center mt-2 gap-3"
    >
